...
const passwords = {
    ...
    "6275": {
        ...
        loans: [
            ...
            { planDate: "01-11-2025", endDate: "30-11-2025<br><ex>(Extended until the end of this month)</ex>", interest: 3200, takenAmount: 5000, takenFrom: "Lendlink - LID", fineRate: 60 },
            { planDate: "06-11-2025", endDate: "30-11-2025<br><ex>(Extended until the end of this month)</ex>", interest: 4680, takenAmount: 10000, takenFrom: "P2P lend", fineRate: 130 },
            { planDate: "09-11-2025", endDate: "30-11-2025<br><ex>(Extended until the end of this month)</ex>", interest: 3600, takenAmount: 7500, takenFrom: "MLLD", fineRate: 85 },
        ]
    },
    "Cherish@123": {
        name: "Cherish #1",
    ...
    loanDetails.innerHTML = `
        ...
        <div class="loan-entry">
            <p style="text-align:center;position:sticky;top:90px;margin-top:20px;right:16px;float:right;margin-right:-9px;">
                <button class="amounts-btn downsingle" style="width:100%;font-size:9px;padding:0px 12px;display:flex;flex-direction:row;justify-content:center;align-items:center;margin-top:10px;font-weight:400;letter-spacing:0.2px;    backdrop-filter: blur(1.5px);" onclick="downloadSingleLoan(${index})">
