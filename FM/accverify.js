...
function displayLoanDetails(loan, index) {
    ...
    loanDetails.innerHTML = `
        <div class="loan-entry">
            <p style="text-align: center; position: sticky; top: 20px; margin-top: 20px; right: 16px; float: right; margin-right: -9px;">
                <button class="amounts-btn downsingle" style="width: 100%; font-size: 10px; padding: 3px 15px; display: flex; flex-direction: row; justify-content: center; align-items: center;" onclick="downloadSingleLoan(${index})">
