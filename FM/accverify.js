const passwords = {
                ...
                if (user.showCustomContent === "yes" && user.customContent && user.customContent.value) {
                    if (user.customContent.type === "text") {
                        specialContentDiv.innerHTML = `
                            <h3 style="color: white; font-size: 16px;">Special Message</h3>
                        ...
                        specialContentDiv.innerHTML = `
                            ...
                            <img class="applybtn" src="${user.customContent.value}" alt="Special Offer"  onerror="this.src='';">
                        `;
                    }
                } else {
                    specialContentDiv.innerHTML = "";
        ...
        // Placeholder theme functions to prevent errors
        ...
        function setCustomTheme() {
            ...
            // Add custom theme logic here if needed
        }
